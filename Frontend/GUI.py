...
class ChatSection(QWidget):
    ...
    def __init__(self):
        ...
        layout.setContentsMargins(-40, 10, 10, 100)  # Adjusted margins to valid values
    ...
    def addMessage(self, message, color):
        ...
        print(f"Added message to chat: {message}")
...
class InitialScreen(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.timer.start(5) # Increased timer interval
